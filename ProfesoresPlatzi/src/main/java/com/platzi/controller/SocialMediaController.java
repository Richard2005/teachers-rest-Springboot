...
import com.platzi.Utils.CustomErrorType;
import com.platzi.model.SocialMedia;
import com.platzi.services.SocialMediaService;
...
public class SocialMediaController {
	...
	@RequestMapping(value="/socialMedias/icon/{icon}",method=RequestMethod.GET,headers="Accept=application/json")
	@ResponseBody
	public ResponseEntity<SocialMedia> getSocialMediaByIcon(@PathVariable("icon") String icon){

		if ( icon == null) {
			return new ResponseEntity<>(HttpStatus.NO_CONTENT);
		}
		else {
			SocialMedia socialMedia = _socialMediaService.findByIcon(icon);
