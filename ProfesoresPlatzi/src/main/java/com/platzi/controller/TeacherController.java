...
import com.platzi.services.TeacherService;
...
public class TeacherController {
	...
	public ResponseEntity<?> deleteCourse(@PathVariable("id") Long id) {
		...
		if (teacher == null) {
			...
			return new ResponseEntity(new CustomErrorType("Unable to delte. Teacher with id" + id + "not found."),HttpStatus.NOT_FOUND);
		}
